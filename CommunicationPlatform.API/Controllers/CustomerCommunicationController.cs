...
[ApiController]
public class CustomerCommunicationController(IMessagingService messagingService,
    ...
    : Controller
{
    ...
    {
        var email = await messagingService.SendMessageAsync(request.CustomerId, request.TemplateId, request.PlaceholderValues);
