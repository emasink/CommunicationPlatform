...
public class MessagingService (ICustomerRepository customerRepository, 
    ITemplateRepository templateRepository,
    IEmailBuilder emailBuilder,
    IEmailSender emailSender)
    : IMessagingService
{
    public async Task<string> SendMessageAsync(int customerId, int templateId, Dictionary<string, string> placeholderValues)
    {
